...
public class IOParameter extends ArrayList implements IIOParameter {
	...
	public IOParameter (final ExecutionParameterType exParam, final InputDescriptionType wpsInput, final OutputDescriptionType wpsOutput){
	...
	/* (non-Javadoc)
	 * @see de.tudresden.gis.geoprocessing.movingcode.iodata.IData#supportsType(de.tudresden.gis.geoprocessing.movingcode.iodata.IODataType)
	 */
	...
	/* (non-Javadoc)
	 * @see de.tudresden.gis.geoprocessing.movingcode.iodata.IData#printPrefix(de.tudresden.gis.geoprocessing.movingcode.iodata.IODataID)
	 */
	...
	/* (non-Javadoc)
	 * @see de.tudresden.gis.geoprocessing.movingcode.iodata.IData#printSuffix(de.tudresden.gis.geoprocessing.movingcode.iodata.IODataID)
	 */
	...
	/* (non-Javadoc)
	 * @see de.tudresden.gis.geoprocessing.movingcode.iodata.IData#printSeparator(de.tudresden.gis.geoprocessing.movingcode.iodata.IODataID)
	 */
	...
	public void add(int index, Object element) {
		...
		} else throw new IllegalArgumentException("Adding object of class " + element.getClass().getCanonicalName() + " is not allowed.\nParameter type was defined as " + supportedType.getSupportedClass().getCanonicalName());
	}
