 ...
 */
public class ProcessorsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements
        org.n52.movingcode.runtime.processorconfig.ProcessorsDocument {
    ...
    private static final javax.xml.namespace.QName PROCESSORS$0 = new javax.xml.namespace.QName("http://52north.org/movingcode/runtime/processorconfig",
                                                                                                "processors");
    ...
    public org.n52.movingcode.runtime.processorconfig.ProcessorsDocument.Processors getProcessors() {
        synchronized (monitor()) {
            ...
            target = (org.n52.movingcode.runtime.processorconfig.ProcessorsDocument.Processors) get_store().find_element_user(PROCESSORS$0,
                                                                                                                              0);
            if (target == null) {
                return null;
            }
     ...
     * This is a complex type.
     */
    public static class ProcessorsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements
            org.n52.movingcode.runtime.processorconfig.ProcessorsDocument.Processors {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName PROCESSOR$0 = new javax.xml.namespace.QName("", "processor");
        private static final javax.xml.namespace.QName DEFAULTS$2 = new javax.xml.namespace.QName("", "defaults");
        ...
        public org.n52.movingcode.runtime.processorconfig.ProcessorType getProcessorArray(int i) {
            synchronized (monitor()) {
                ...
                target = (org.n52.movingcode.runtime.processorconfig.ProcessorType) get_store().find_element_user(PROCESSOR$0,
                                                                                                                  i);
                if (target == null) {
        ...
        public org.n52.movingcode.runtime.processorconfig.ProcessorType insertNewProcessor(int i) {
            synchronized (monitor()) {
                check_orphaned();
                org.n52.movingcode.runtime.processorconfig.ProcessorType target = null;
                target = (org.n52.movingcode.runtime.processorconfig.ProcessorType) get_store().insert_element_user(PROCESSOR$0,
                                                                                                                    i);
                return target;
            }
        }
        ...
        public org.n52.movingcode.runtime.processorconfig.DefaultsType getDefaults() {
            synchronized (monitor()) {
                ...
                target = (org.n52.movingcode.runtime.processorconfig.DefaultsType) get_store().find_element_user(DEFAULTS$2,
                                                                                                                 0);
                if (target == null) {
                    return null;
                }
