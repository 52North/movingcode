 ...
 */
public class DefaultsTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements
        org.n52.movingcode.runtime.processorconfig.DefaultsType {
    ...
    private static final javax.xml.namespace.QName TEMPWORKSPACE$0 = new javax.xml.namespace.QName("", "tempWorkspace");
    private static final javax.xml.namespace.QName AVAILABLEPLATFORM$2 = new javax.xml.namespace.QName("",
                                                                                                       "availablePlatform");
    ...
    public void insertAvailablePlatform(int i, java.lang.String availablePlatform) {
        synchronized (monitor()) {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = (org.apache.xmlbeans.SimpleValue) get_store().insert_element_user(AVAILABLEPLATFORM$2,
                                                                                                                       i);
            target.setStringValue(availablePlatform);
        }
    }
