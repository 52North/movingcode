...
public class RServerController {
	 ...
	 * @return
	 */
	public static boolean execute(String workspacePath, String function, String scriptPath, String[] parameters, String[] libraries) {
		try {
			...
			// String stations = "c('DESN017','DESN045','DESN079','DESN076','DESN004','DESN075','DESN061','DESN012','DESN047','DESN060','DESN074','DESN019','DESN050','DESN025','DESN051','DESN024','DESN014','DESN049','DESN020','DESN011','DESN077','DESN085','DESN059','DESN006','DESN084','DESN083')";
			// String measurements = "c(27.33,26.77,21.50,20.44,25.45,28.06,34.42,25.65,25.44,26.25,18.70,27.85,25.03,37.09,23.91,21.74,33.35,14.14,32.14,25.52,38.94,27.36,23.38,31.49,33.39,34.99)";
	 ...
	 * @param RData Name of the RData file, relative to R workspace
	 */
