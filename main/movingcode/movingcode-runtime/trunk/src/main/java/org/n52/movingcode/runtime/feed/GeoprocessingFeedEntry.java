...
public final class GeoprocessingFeedEntry {
	...
	public GeoprocessingFeedEntry(PackageDescriptionDocument packageDesc, Date creationDate, String packageURL, String descriptionURL){
...
//			this.entry.setSummaryAsHtml(summary); // set summary //TODO: a detailed IO description of the feed, 
			...
			// e.g. <link rel="alternate" href="http://www.gtfs-data-exchange.com/meta/6195524" type="text/html"/>
