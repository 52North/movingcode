...
public class JavaJARProcessor extends AbstractProcessor{
	...
	public void execute(int timeoutSeconds) throws IllegalArgumentException, RuntimeException, IOException {
		...
		executable = this.clonedWorkspace
					+ File.separator
					+ executable;
	 ...
	 */
	private static String[] buildArgs(SortedMap<ParameterID,String[]> executionValues, SortedMap<ParameterID, IOParameter> paramMap) throws IllegalArgumentException{
