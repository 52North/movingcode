...
public class WPSDescriptionPrinter {
	...
	private static final String COMMON_HTML_TEMPLATE_PARAM = 
		"<p><b><tt><big>%identifier%</big></tt> - %title%</b>" + 
		"<br/>%abstract%<br/></p>";
	...
	// XHTML templates
	private static final String COMMON_XHTML_TEMPLATE_PROCESS = 
		"<xhtml:h3>%identifier%</xhtml:h3>" +
		"<xhtml:h4>%title%</xhtml:h4>" + 
		"<xhtml:p>%abstract%</xhtml:p>";
	
	private static final String COMMON_XHTML_TEMPLATE_PARAM = 
		"<xhtml:h4>%identifier%</xhtml:h4>" +
