...
public interface IIOParameterMap extends SortedMap<ParameterID, IOParameter>{
	...
	/**
	 * Method for adding data to this map using the ParameterID.
	 * (The {@link ParameterID} is the *internal* ID of the parameter)
	 * 
	 * 
	 * @param identifier
	 * @param data
	...
	/**
	 * Method for removing data from this map using the ParameterID.
	 * (The {@link ParameterID} is the *internal* ID of the parameter)
	 * 
	 * 
	 * @param identifier
	...
	/**
	 * Method for adding data to this map using the message ID.
	 * (The message ID public ID of the parameter from the functional description)
	 * 
	 * 
	...
	/**
	 * Method for removing data from this map using the message ID.
	 * (The message ID public ID of the parameter from the functional description)
	 * 
	 * 
	 * @param {@link String} identifier
